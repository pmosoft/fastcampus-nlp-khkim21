import sys
sys.path.insert(0,'d:/lge/pycharm-projects/Fastcampus/NLP-Gen/simple-nmt-master/')
# sys.path.insert(0,'d:/lge/pycharm-projects/Fastcampus/NLP-Gen/simple-nmt-master/simple_nmt/')
...
class MaximumLikelihoodEstimationEngine(Engine):
    ...
    def train(engine, mini_batch):
        ...
        ############################################
        # Automatic Mixed Precision : off_autocast
        ############################################
        ...
        #################################################
        # Gradient Accumulations : iteration_per_update
        #################################################
