...
if __name__ == '__main__':
    ...
    loader = DataLoader(
        '../data/corpus.shuf.train.tok.bpe',
        '../data/corpus.shuf.valid.tok.bpe',
        ('en', 'ko'),
        batch_size=128,
        device=-1
    )
    ...
    for batch_index, batch in enumerate(loader.train_iter):
        ...
        print(batch_index, batch.src[0].shape, batch.tgt[0].shape)

        #detoken = []
        #for a in batch.src[0][40]: detoken.append(loader.src.vocab.itos[int(a)])
